...
<style>
:root{--primary:#2563eb;--primary-dark:#1d4ed8;}*{margin:0;padding:0;box-sizing:border-box;}body{min-height:100vh;font-family:'Inter',sans-serif;background:linear-gradient(rgba(15,23,42,.84),rgba(15,23,42,.92)),url('../sports.jpeg') center center/cover no-repeat fixed;display:flex;align-items:center;justify-content:center;padding:40px 20px;} .auth-card{background:rgba(255,255,255,.08);backdrop-filter:blur(18px);border:1px solid rgba(255,255,255,.12);border-radius:30px;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,.35);width:min(520px,100%);} .auth-body{padding:42px;} .logo-badge{width:64px;height:64px;border-radius:20px;background:linear-gradient(135deg,#2563eb,#60a5fa);display:flex;align-items:center;justify-content:center;color:white;font-size:24px;margin-bottom:26px;box-shadow:0 16px 34px rgba(37,99,235,.35);} .heading{color:white;font-size:2rem;font-weight:800;letter-spacing:-1px;margin-bottom:10px;} .subheading{color:rgba(255,255,255,.7);line-height:1.7;margin-bottom:34px;font-size:.94rem;} .form-group{margin-bottom:22px;} .form-label{display:block;color:rgba(255,255,255,.88);font-size:.84rem;font-weight:600;margin-bottom:10px;} .input-wrapper{position:relative;} .input-wrapper i{position:absolute;top:50%;left:18px;transform:translateY(-50%);color:rgba(255,255,255,.4);font-size:14px;} .form-control{width:100%;height:56px;border:none;border-radius:18px;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.08);padding:0 18px 0 50px;color:white;font-size:.95rem;transition:.2s ease;} .form-control:focus{outline:none;border-color:rgba(96,165,250,.6);background:rgba(255,255,255,.12);box-shadow:0 0 0 4px rgba(37,99,235,.15);} .form-control.is-invalid{border-color:#ef4444;} .invalid-feedback{margin-top:8px;color:#fca5a5;font-size:.8rem;} .auth-button{width:100%;border:none;border-radius:18px;background:#2563eb;color:white;font-size:.95rem;font-weight:700;padding:16px;cursor:pointer;transition:.2s ease;} .auth-button:hover{background:#1d4ed8;} .bottom-text{margin-top:24px;color:rgba(255,255,255,.7);font-size:.92rem;text-align:center;} .bottom-text a{color:white;text-decoration:none;font-weight:700;} .alert-modern{padding:16px;border-radius:16px;background:rgba(220,38,38,.12);color:#fee2e2;margin-bottom:24px;border:1px solid rgba(248,113,113,.18);} .alert-success{padding:16px;border-radius:16px;background:rgba(34,197,94,.12);color:#dcfce7;margin-bottom:24px;border:1px solid rgba(74,222,128,.18);} .small-text{color:rgba(255,255,255,.7);font-size:.88rem;margin-top:8px;}
</style>
</head>
<body>
<div class="auth-card">
